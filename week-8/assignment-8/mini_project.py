...
def collect_messy_data(path):
    ...
    try:
        ...
        return 
    return clean_list_dict, messy_list_dict, rows_num


def report(clean, messy, attempts):

    print ("=== CSV Report ===")
    print (f"Rows attempted:  {attempts}")
...
clean_list_dict, messy_list_dict, rows_num=collect_messy_data(path_name)
report(clean_list_dict, messy_list_dict, rows_num)
